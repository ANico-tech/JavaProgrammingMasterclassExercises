...
Write a class with the name Person. The class needs three fields (instance variables) with the names firstName, lastName of type String
 and age of type int.
...
To check if s String is empty,
use the method isEmpty from the String class.
